# ⚡ Apex Roblox Executor (Experimental, Early Beta)

### 🚀 Coming soon! (Made entirely by me, codydork, a team is coming soon) watch 👀 or star ⭐ this repo to keep up with whats happening.

---

NOTE: feel free to decompile this upon release to ensure its not a **RAT**, as i am fine with people looking at how this works, but you ***CANNOT SKID*** the code, or the workings of the code responsible for automating doing the exploit and giving admin level access, and bypassing fe and hyperion either, which cannot be decompiled from the exe, incase you try to skid it, because I cannot stand skidding, as it has happened in prev projects.
...
- **💾 Advanced SaveInstance:** Due to the fact that you have admin-like privileges, you can access server sided scripts and other things you normally wouldnt be able to saveinstance. the **SaveInstance** feature allows users to save **server scripts**, **local scripts**, and other assets with impressive speed and precision. It's optimized for accuracy and is faster than other executors.
